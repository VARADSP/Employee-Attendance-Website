...
if(isset($_REQUEST['id']))
{
	...
	$sel = "select * from users where id='$ed'";
...
<!-- Mirrored from dreamguys.co.in/smarthr/purple/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Oct 2018 15:44:16 GMT -->
<head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">
        <link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.png">
        <title>Profile - TimeLabs admin </title>
										...
										<div class="row">
											<div class="col-md-5">
												<div class="profile-info-left">
													<h3 class="user-name m-t-0 m-b-0"><?php echo $res->name; ?></h3>
													<small class="text-muted"><?php echo $res->address; ?></small>
											...
											<div class="col-md-7">
												<ul class="personal-info">
													<li>
														...
														<span class="text"><a href="#"><?php echo $res->mobileno; ?></a></span>
													</li>
													<li>
														<span class="title">Email:</span>
														<span class="text"><a href="#"><?php echo $res->email; ?></a></span>
													</li>
													<li>
